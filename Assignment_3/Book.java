// Develop a Book class using constructors and exception handling.
//  Store and manage records using ArrayList.
...
public class Book{
    ...
    public Book(String title, double price, String ISBN, String genre, String author) throws InvalidPriceException, InvalidBookGenreException{
        ...
        if (!genre.equals("Fiction") && !genre.equals("Non-fiction") && !genre.equals("Auto-biography"))
            throw new InvalidBookGenreException("Invalid genre of book: " + title);
        this.genre = genre;
        this.price = price;
    }
    public Book(String title, String author, String genre)throws InvalidBookGenreException{
        this.title = title;
        this.author = author;
        if (!genre.equals("Fiction") && !genre.equals("Non-fiction") && !genre.equals("Auto-biography"))
            throw new InvalidBookGenreException("Invalid genre of book: " + title);
